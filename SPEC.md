...
- removing an app deletes that configured app's local setup, schedules, app-scoped rules, notification overrides, credential reference and stored credential material, active resources, metrics, and sync state without uninstalling the plugin or deleting historical events and audit entries;
